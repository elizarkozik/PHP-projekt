...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    if(isset($_SESSION['role'])){
       echo '<a class="nav-link" href="my_message.php">Skapa inlägg <span class="sr-only">(current)</span></a>';
      }
      ?>
      </li>
...
<div class="site">
	<div class="hero">
		<h1 class=".blogg-title_h1">Millhouses Blogg - Accessoarer</h1>
	</div>
  <?php
...
$stm = $pdo->query("SELECT Title, Entry, EntryDate, CategoryId, Id FROM Entries ORDER BY EntryDate DESC");
    ...
    "<a href='my_message.php?id=".$row['Id']."'>MODIFY</a>" . " " . "<br>"; 
    }​​​​​ */
...
if(isset($_SESSION['role'])){
   ...
   echo "<a href='change_message.php?id=".$row['Id']."'>Ändra</a></br>";
}
